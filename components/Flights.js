...
export default function Flights({navigation}) {
    ...
    const renderItem = data => (
        ...
        >
            ...
            <View style={{backgroundColor:"#6750A4",borderRadius:30,height:50,width:50,justifyContent:"center",alignItems:"center",marginRight:10}}>
                <Text style={{color:"white",fontSize:25}}>A</Text>
            </View>
            <View>
                <Text style={{fontSize:15}}>N123AB</Text>
                <Text style={{fontSize:15}}>4 <Icons color="black" name="user-nurse" size={15}/> 4 <Icons color="black" name="user-friends" size={15}/></Text>
