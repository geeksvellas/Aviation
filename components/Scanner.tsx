...
import {MRZResultTable} from './MRZResultTable';
...
export default function ScannerScreen({route, navigation}) {
    ...
    if (imageData) {
      return (
        <Svg style={styles.srcImage} viewBox={getViewBoxForCroppedImage()}>
          <Image width="100%" height="100%" href={{uri: imageData}} />
  ...
  const frameProcessor = useFrameProcessor(frame => {
    ...
    if (modalVisibleShared.value === false) {
      ...
      config.license =
        'DLS2eyJoYW5kc2hha2VDb2RlIjoiMTAxMzUzNjUwLVRYbE5iMkpwYkdWUWNtOXFYMlJzY2ciLCJvcmdhbml6YXRpb25JRCI6IjEwMTM1MzY1MCIsImNoZWNrQ29kZSI6MzAyNjcwNDQzfQ=='; //public trial
