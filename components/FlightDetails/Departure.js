  ...
  return (
    <ScrollView>
      ...
      <View style={{padding: 20}}>
        ...
        {/*   ------------------------------Crew Movement	 ----------- */}
        <Text style={[styleSheet.label, {marginTop: 10}]}>Crew Movement:</Text>
        <View
          style={{
            borderWidth: 1,
              ...
              {departure[3].file.map((value, index) => {
                return (
                  <View
                    ...
                    <TouchableOpacity onPress={() => removeFilePreA(3, index)}>
                      <Icons
        ...
        {/*   ------------------------------Water Service ----------- */}
        <Text style={[styleSheet.label, {marginTop: 10}]}>Water Service:</Text>
        <View
          style={{
            borderWidth: 1,
            borderColor: 'rgba(0,0,0,0.5)',
              ...
              {departure[29].file.map((value, index) => {
                return (
                  <View
                    ...
                    <Text style={{color: 'black'}}>{value.name}</Text>
                    <TouchableOpacity onPress={() => removeFilePreA(29, index)}>
                      <Icons
                        style={{color: 'green', marginLeft: 10}}
                        name="close"
                        size={30}
              ...
              {departure[36].file.map((value, index) => {
                return (
                  <View
                    ...
                    <Text style={{color: 'black'}}>{value.name}</Text>
                    <TouchableOpacity onPress={() => removeFilePreA(36, index)}>
                      <Icons
                        style={{color: 'green', marginLeft: 10}}
                        name="close"
                        size={30}
